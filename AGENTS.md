...
线 1（专利文本）：A 说明书全文 V1（按 17 号骨架 §1–§16 展开）→ A+C 第二轮并排校验
...
**线 1（专利文本）**：A 说明书全文（按 `patent_definition/17_A说明书骨架_V1.md` §1–§16 展开）→ A+C 第二轮并排校验（两案全文就绪后互相校验术语与污染）。
...
reports/patent_definition/17_A说明书骨架_V1.md                     # A 说明书骨架（PASS WITH EXPERIMENT PLAN；三条义务）
