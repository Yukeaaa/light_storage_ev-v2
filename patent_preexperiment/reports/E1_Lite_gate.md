...
数据边界（`results/raw/K0/audit_jpl_pilot_quality.json`）：JPL pilot 值仅存在于 2020-06~2020-12；合格（匹配≥300 且 pilot 值覆盖≥0.8）仅 2020-06/07。冻结过滤统一使用 **cycle_month**（分钟/控制周期所在月份）；E0-Full 时间切分另用 session connection time，两种月份用途不同。
