...
- planned_bess_delta = park_requested - ev_accepted（事前正常协调）
...
def replay_arm(
    ...
    *,
    ...
    """对单 arm 在 M2 正向事件上回放，返回每事件的 8 个核心量（kW）。"""
    ...
    ev_accepted = compute_arm_allowed_up(
